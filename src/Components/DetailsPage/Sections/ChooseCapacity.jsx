...
export const ChooseCapacity = () =>
{
        ...
        return (
            <div
                ...
                className={`w-48 h-28 flex flex-col justify-center items-center gap-2 rounded-3xl border border-gray-400 cursor-pointer
                 ${activeCapacity === capacity && 'border border-transparent outline outline-4 outline-blue-300'}`}>
                <div>
    ...
    return (
        <>
            <div className={`w-full pb-7 flex flex-col justify-center items-start gap-1 mt-3 border-b border-gray-400 ${!enableSectionCapacity && 'pointer-events-none opacity-30' }`}>
