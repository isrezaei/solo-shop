...
export const BottomHeader = () =>
{
    ...
    return (
        ...
        lg:justify-evenly lg:items-center`}>
            ...
            lg:max-w-[1400px] lg:px-14 lg:w-full lg:mt-[4rem] lg:m-auto lg:h-20 lg:flex lg:items-center lg:justify-between lg:mt-20
...

                {
                    showSearchInput || location.pathname === '/search' ?
                        ...
                        <div className='
                         flex
                         xs:w-full
                         lg:w-10/12 lg:justify-center lg:gap-12 lg:items-center
                         2xl:gap-16
