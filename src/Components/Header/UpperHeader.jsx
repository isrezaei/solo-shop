...
export const UpperHeader = ({headerPosition}) =>
{
    ...
    return (
        <div className={` 
          ...
          2xl:w-full 2xl:h-20 2xl:top-0 ${headerPosition}`
        }>
            <div className='
            xs:w-96 xs:justify-start xs:item-center xs:m-0
            lg:w-10/12 lg:flex lg:justify-between lg:items-center
            2xl:h-20
            '>
                <div className='
                xs:hidden
                lg:w-80 lg:block lg:flex lg:justify-evenly lg:items-center
                '>
