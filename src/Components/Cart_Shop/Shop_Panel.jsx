        ...
        <>
            <div className='
                ...
                <div className='xs:h-16 lg:h-10 lg:pb-4 lg:mt-5 w-full flex items-center border-b border-b-gray-300'>
                    <button className='xs:w-20 xs:h-8 xs:rounded-full xs:text-sm md:text-[.8rem] lg:w-20 lg:h-8 bg-blue-700 text-white lg:text-[.8rem]'>APPLY</button>
                </div>
                ...
                <div className='w-full xs:h-36 lg:h-56  flex flex-col justify-center gap-3 items-center'>
                    <button className='w-72 xs:h-8 xs:rounded-full xs:text-sm md:w-52 md:text-[.8rem] lg:w-52 lg:h-10 lg:text-[.9rem] bg-blue-700 text-white'>Continue & CHECKOUT</button>
                    <button className='w-72 xs:h-8 xs:rounded-full xs:text-sm md:w-52 md:text-[.8rem] lg:w-52 lg:h-10 lg:text-[.9rem] bg-red-500 text-white' onClick={clearAndBack}>CLEAR CART & BACK</button>
                    <div className='w-40 h-8 rounded-full text-blue-900 flex justify-center items-center gap-2 cursor-pointer bg-white'>
                        ...
                        <Link to='/'>
                            <p className='xs:text-sm md:text-[.8rem] lg:text-sm'>Back to shopping</p>
                        </Link>
                    </div>
                </div>
            </div>
